...
var productCardContainer = "";
for (var i = 0; i < allProducts.products.length; i++) {
  var product = {
    title: allProducts.products[i].title,
    descreption: allProducts.products[i].description,
    images: allProducts.products[i].images[0],
    category: allProducts.products[i].category,
    price: allProducts.products[i].price,
  };
  productCardContainer =
    productCardContainer +
    `<div class="col-md-6 col-lg-4 col-xl-3 mt-3">
          <div class="card bg-primary-subtle px-3">
            <img src=${product.images} class="card-img-top w-100" alt="..." />
            <div class="card-body">
...
row.innerHTML = productCardContainer;
